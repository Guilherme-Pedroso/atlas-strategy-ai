      ...
      <div className="container-atlas">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-atlas-highlight">Marketing Atlas</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Consultoria de marketing automatizada com inteligência artificial personalizada para 
              pequenos empresários, infoprodutores e e-commerces.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} Marketing Atlas. Todos os direitos reservados.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-atlas-highlight">
